<div class="navbar  sticky mynavbar">
    <div class="flex-1">
        <div class="flex items-center ms-3">
            <a class="text-2xl font-bold" href="{{ route('home') }}">
                <img class="w-20 me-1" src="{{ Vite::asset('resources/images/logo.png') }}" alt="">
    ...
    @if (request()->is('admin') || request()->is('admin/*'))
        <a wire:navigate href="{{ route('admin.index') }}" class="btn mx-3"><svg xmlns="http://www.w3.org/2000/svg"
